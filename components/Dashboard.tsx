    ...
    <div className='flex flex-col flex-1 gap-8 sm:gap-12 md:gap-16'>
      ...
      <div className='flex items-stretch flex-wrap gap-4'>
        {Object.keys(moods).map((mood, moodIndex)=>{
          return (
            <button className={' p-4 px-5 rounded-2xl purpleShadow duration-200 bg-indigo-50 hover:bg-indigo-100 text-center items-center flex flex-col gap-2 flex-1'} key={moodIndex}>
